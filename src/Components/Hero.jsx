...
const Hero = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black h-screen">
      ...
      <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 text-center text-white z-10 px-4">
        <motion.h1
